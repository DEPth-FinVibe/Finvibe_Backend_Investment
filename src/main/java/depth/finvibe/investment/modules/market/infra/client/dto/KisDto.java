...
public class KisDto {
    ...
    @Data
    @Builder
    public static class IndexPriceResponse {
        private String rt_cd;
        private String msg_cd;
        private String msg1;
        private IndexPriceOutput output;
    }
    ...
    @Data
    @Builder
    public static class IndexPriceOutput {
    ...
    @Data
    @Builder
    public static class TimeIndexChartPriceResponse {
        private String rt_cd;
        private String msg_cd;
        private String msg1;
        private TimeIndexChartPriceOutput1 output1;
        private List<TimeIndexChartPriceOutput2> output2;
    }
    ...
    @Data
    @Builder
    public static class TimeIndexChartPriceOutput1 {
        private String bstp_nmix_prdy_vrss;
        private String prdy_vrss_sign;
        private String bstp_nmix_prdy_ctrt;
        private String acml_vol;
    ...
    @Data
    @Builder
    public static class TimeIndexChartPriceOutput2 {
        private String stck_bsop_date;
        private String stck_cntg_hour;
        private String bstp_nmix_prpr;
        private String bstp_nmix_oprc;
    ...
    /**
     * 국내주식업종기간별시세(일/주/월/년) 응답 DTO
     */
    @AllArgsConstructor
    @NoArgsConstructor
    @Data
    @Builder
    public static class DailyIndexChartPriceResponse {
        private String rt_cd;
        private String msg_cd;
        private String msg1;
        private DailyIndexChartPriceOutput1 output1;
        private List<DailyIndexChartPriceOutput2> output2;
    }
    ...
    @Data
    @Builder
    public static class DailyIndexChartPriceOutput1 {
        private String bstp_nmix_prdy_vrss;
        private String prdy_vrss_sign;
        private String bstp_nmix_prdy_ctrt;
        private String acml_vol;
    ...
    @Data
    @Builder
    public static class DailyIndexChartPriceOutput2 {
        private String stck_bsop_date;
        private String bstp_nmix_prpr;
        private String bstp_nmix_oprc;
        private String bstp_nmix_hgpr;
